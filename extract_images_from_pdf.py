...
# -*- coding: utf-8 -*-
"""
PDF에서 이미지를 추출하여 JPG 파일로 저장하는 스크립트
"""
...
def extract_images_from_pdf(pdf_path, output_dir=os.path.join(os.getcwd(), "extracted_images")):
    """
        ...
        for page_num in range(len(pdf_document)):
            ...
            for img_index, img in enumerate(image_list):
                try:
                    ...
                    # JPG로 저장
                    output_filename = f"page_{page_num + 1}_image_{img_index + 1}.jpg"
